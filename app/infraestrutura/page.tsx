...
export default function InfrastructurePage() {
  return <>
    <PageHero eyebrow="Infraestrutura" title="Uma estrutura preparada para grandes operações." intro="Ambientes, fluxos e recursos pensados para acomodar diferentes necessidades logísticas com controle e flexibilidade." image="/images/hero-logistics.jpg" imageAlt="Complexo logístico contemporâneo em imagem editorial" />
