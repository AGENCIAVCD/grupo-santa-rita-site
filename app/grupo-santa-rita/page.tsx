...
export default function AboutPage() {
  return <>
    <PageHero eyebrow="Grupo Santa Rita" title="Experiência operacional com a proximidade de quem constrói junto." intro="Uma empresa fundada para oferecer um serviço logístico personalizado, com seriedade, comprometimento e parceria." image="/images/operations-team.png" imageAlt="Equipe editorial de operações reunida" />
    ...
    <SplitFeature image="/images/distribution.png" imageAlt="Operação editorial de distribuição" eyebrow="Qualidade e tecnologia" title="Investimento contínuo no que sustenta a operação." text="A Santa Rita investe em profissionais, tecnologia e equipamentos para ampliar a capacidade de resposta e manter a operação preparada para necessidades diversas." reverse />
    <CtaBand />
  </>;
}
