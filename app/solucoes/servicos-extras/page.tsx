...
export default function ExtraServicesPage() {
  return <>
    ...
    <SplitFeature image="/images/cold-storage.png" imageAlt="Operação editorial em centro de armazenagem" eyebrow="Sob medida" title="Uma extensão da operação do cliente." text="Equipe, espaço e processo podem ser dedicados a atividades específicas, com treinamento alinhado às particularidades de cada projeto.">
