...
export default function DistributionPage() {
  return <>
    <PageHero eyebrow="Soluções / Distribuição" title="Precisão para movimentar. Visibilidade para decidir." intro="Distribuição coordenada para cargas fracionadas e fechadas, com monitoramento e informação ao longo do processo." image="/images/distribution.jpg" imageAlt="Caminhões refrigerados em operação editorial de docas" />
