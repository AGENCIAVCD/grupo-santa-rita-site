...
export const metadata: Metadata = pageMetadata("Distribuição", "Cargas fracionadas e fechadas, agendamento, monitoramento e análise de performance para uma distribuição coordenada.", "/solucoes/distribuicao");

export default function DistributionPage() {
  return <>
    <PageHero eyebrow="Soluções / Distribuição" title="Precisão para movimentar. Visibilidade para decidir." intro="Distribuição coordenada para cargas fracionadas e fechadas, com monitoramento e informação ao longo do processo." image="/images/distribution.png" imageAlt="Caminhões refrigerados em operação editorial de docas" />
    ...
    <SplitFeature image="/images/hero-logistics.png" imageAlt="Complexo logístico editorial com docas e caminhões" eyebrow="Distribuição flexível" title="Planejada para o destino. Ajustada à operação." text="Agendamentos, entregas com restrições e cross-docking podem fazer parte de um desenho operacional orientado à agilidade e ao controle.">
