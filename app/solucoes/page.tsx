  ...
  return <>
    ...
    <section className="solution-detail-list shell">
      {solutions.map((solution, index) => <Reveal className="solution-detail" key={solution.href}>
        <div className="solution-detail-image"><Image src={solution.image} alt="Imagem editorial ilustrativa de solução logística" fill sizes="(max-width: 900px) 100vw, 45vw" className="cover-image" /><span>0{index + 1}</span></div>
