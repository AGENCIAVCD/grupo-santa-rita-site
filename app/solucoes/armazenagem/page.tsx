...
export default function StoragePage() {
  return <>
    <PageHero eyebrow="Soluções / Armazenagem" title="Cada produto no ambiente certo. Cada movimento sob controle." intro="Estrutura multitemperatura e processos adaptáveis para preservar as condições de armazenagem e dar fluidez à operação." image="/images/cold-storage.png" imageAlt="Corredor editorial de armazém refrigerado com empilhadeira" />
