...
export const metadata: Metadata = pageMetadata("Armazenagem Multitemperatura", "Soluções para produtos congelados, resfriados, climatizados e secos com picking e estoque endereçado.", "/solucoes/armazenagem");
...
export default function StoragePage() {
  return <>
    ...
    <SplitFeature image="/images/hero-logistics.jpg" imageAlt="Vista aérea editorial de centro de distribuição" eyebrow="Controle de estoque" title="Endereçamento, giro e separação orientados ao fluxo." text="Estoque endereçado e áreas para picking criam uma base organizada para movimentações mais claras e aderentes à necessidade do produto.">
